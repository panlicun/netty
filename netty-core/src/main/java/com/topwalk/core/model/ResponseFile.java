...
public class ResponseFile extends BaseModel implements Serializable {
	...
	public ResponseFile(long start, String file_md5,long progress,RequestFile requestFile) {
		super();
		this.start = start;
		this.file_md5 = file_md5;
		this.end = false;
